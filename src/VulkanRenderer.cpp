...
void VulkanRenderer::initWindow() {
    ...
    window = glfwCreateWindow(WIDTH, HEIGHT, "vulkan_renderer", nullptr, nullptr);
...
void VulkanRenderer::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage,
    ...
    // TODO
    // This is not optimal,
    // should use a custom allocator
    // This allocator should use offset parameters for many different objects
    // Won't be hitting any limits in this though, will be relevant when drawing much more detail
...
void VulkanRenderer::updateUniformBuffer(uint32_t currentImage) {
    ...
    ubo.proj[1][1] *= -1; // Flip Y coordinate because GLM was for OpenGL (Everything will be upside down otherwise)
